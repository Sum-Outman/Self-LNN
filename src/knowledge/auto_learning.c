...
static int extract_entities(const char* text, char*** entities, int* entity_count) {
    ...
    static const char* stopwords[] = {
        ...
        /* P2-FIX-17: 扩充中文停用词表到约200词，覆盖高频虚词和功能词 */
        "着","或","一","不","很","为","被","把","对","所","等","从","到",
        "向","以","由","自","于","后","前","上","下","中","内","外","左","右",
        "可","能","会","要","将","已","曾","正","在","还","又","再","也",
        "之","其","些","某","各","每","几","多","少","么","吗","呢","吧","啊",
        "虽然","但是","如果","因为","所以","然而","而且","并且","或者","以及",
        "可以","需要","应该","必须","能够","可能","已经","正在","一直",
        "真的","确实","实在","非常","特别","比较","稍微","过于","极其",
        "突然","马上","立刻","已经","曾经","将要","不会","不必","不用",
        "东西","事情","方面","问题","情况","时候","地方","方式","关系",
        "开始","变成","出现","发展","进行","通过","为了","另外","例如",
        "所有","这些","那些","这个","那个","这样","那样","各种","不同",
        NULL
    };

    /* F-042: 中文实体词典 — 常见实体前缀/后缀指示词 */
    /* P2-FIX-17: 扩充实体后缀表从约40词到100+词，覆盖更广泛实体类型 */
    static const char* entity_suffixes[] = {
        /* 组织机构 */
        "公司","集团","有限","股份","科技","技术","银行","保险","基金","证券",
        "大学","学院","中学","小学","医院","研究所","实验室","中心","研究院",
        "协会","商会","联盟","委员会","政府部门","办事处","派出所",
        /* 地名 */
        "省","市","县","区","镇","村","路","街","大道","广场","开发区","新区",
        "公园","景区","机场","车站","码头","港口","大桥",
        /* 人物 */
        "先生","女士","教授","博士","总统","主席","总理","部长","局长","经理",
        "工程师","设计师","分析师","顾问","专家","学者",
        /* 技术 */
        "系统","平台","框架","模型","网络","算法","数据","应用","服务","方案",
        "程序","软件","硬件","设备","装置","接口","协议","标准","规范",
        "代码","脚本","函数","方法","类","接口","模块","组件","引擎",
        /* 活动/事件 */
        "大会","会议","论坛","展览","项目","计划","工程","行动","运动","赛事",
        "培训","讲座","发布会","评选","活动","竞赛",
        NULL
    };
