...
/* 损失函数默认超参数——DEEP-005修复: MSVC不支持C11 _Atomic，使用volatile替代 */
static volatile float g_default_focal_gamma = 2.0f;
static volatile float g_default_focal_alpha = 0.25f;
static volatile float g_default_dice_smooth = 1e-6f;
static volatile float g_default_triplet_margin = 1.0f;
