 ...
 * @brief 增强规划引擎接口 — 【高级增强功能（与基础版互补，非替代）】
 *
 * P3-004 功能边界说明:
 *   ✅ 本文件: 时间推理规划(STN/STPU)、并发多智能体规划、HTN层次任务网
 *   ✅ 本文件: 条件规划（感知信息决策）、偏序规划、CfC液态演化规划
 *   ✅ 本文件: 与 planning.h 基础版协同工作，扩展高级规划能力
 *   ❌ 非本文件: 核心规划引擎（层次/顺序/并行/反应式/MCTS）
 *                → 请使用 planning.h（基础功能实现）
 *
